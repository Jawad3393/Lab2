...
public class DoubleZero {
	...
	public static void main(String[] args) {
		...
		// If I print 'b', I think i will get something like undefined or error because anything divided 
		// 0 is undefined. 
		...
		// What prints out? Why? 
		// Write your answer here: You get an error and that's because 17.0 is a double but we called it an int so the computer cant compile that.

		// TODO: Change the type of `c` to int and 17.0 to 17 and run the code.
		// What prints out? Why?
		// Write your answer here: It prints out c is 17 and sqroot is 4.123105... and thats because the computer can process 17 as an int and it continues with the code

		// TODO: Change the type of `c` to int and 17.0 to 17 and
		// change the type of `sqroot` to int. You should get an error. Why?
		// Write your answer here: I think it's because the answer should be a double and it can't process that we want an int.
		...
		// Write your answer here: It prints a 4 and its because we told java that we want the answer as an int so it can convert the double to int.
